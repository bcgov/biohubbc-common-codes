...
begin
  ...
  SELECT p_code_header_id, p_code_name, p_code_description, p_code_sort_order, current_ts, p_valid_to, current_ts, current_ts, p_user_id, p_user_id from codes.code 
